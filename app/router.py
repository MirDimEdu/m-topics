...
router_posts_multiple = APIRouter(
    prefix='/posts'
)
...
@router_posts.delete('/{post_id}/delete')
...
@router_posts.post('/{post_id}/comment/add')
...
@router_posts.get('/{post_id}/comments/all')
...
@router_comments.delete('/{comment_id}/delete')
